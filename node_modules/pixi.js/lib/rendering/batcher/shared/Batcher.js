...
const _Batcher = class _Batcher {
  ...
  break(instructionSet) {
    ...
    let textureBatch = (_a = this._textureBatchPool)[_b = this._textureBatchPoolIndex++] || (_a[_b] = new BatchTextureArray.BatchTextureArray());
    textureBatch.clear();
    ...
    for (let i = this.elementStart; i < this.elementSize; ++i) {
      ...
      if (textureBatch.count >= maxTextures || blendModeChange) {
        ...
        textureBatch = (_e = this._textureBatchPool)[_f = this._textureBatchPoolIndex++] || (_e[_f] = new BatchTextureArray.BatchTextureArray());
        textureBatch.clear();
